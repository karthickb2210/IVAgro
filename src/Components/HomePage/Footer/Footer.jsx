  ...
  return (
    <>
      <footer className="bg-teal-950">
        <div className="container px-6 py-6 mx-auto bottom-0">
          ...
          <hr className="my-2 md:my-4 border-gray-700" />
          ...
          {/* <div className="flex items-center justify-between">
            ...
            <div className="flex -mx-2">
              ...
              <a
                href="#"
                className="mx-2  transition-colors duration-300 dark:text-gray-300 hover:text-blue-400"
                aria-label="Facebook"
              >
                <svg
                  className="w-5 h-5 fill-current"
