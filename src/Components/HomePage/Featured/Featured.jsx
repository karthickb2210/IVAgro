        ...
        <div className="container px-6 py-10 mx-auto">
          ...
          <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-3">
            <div className="flex flex-col items-center p-6 space-y-3 text-center bg-gray-100 rounded-xl ">
              ...
              >
                As soon as it gets harvested from our state of the art
                hydroponic and Aeroponic grow systems
              </motion.p>
            ...
            <div className="flex flex-col items-center p-6 space-y-3 text-center bg-gray-100 rounded-xl">
              <span className="inline-block p-3 text-blue-500 bg-blue-100 rounded-full dark:text-white ">
                <svg
                  className="w-10 h-10"
                  viewBox="0 0 48 48"
                  fill="none"
              ...
              <motion.p
                ...
                className="text-gray-500 "
              >
                We make our environment pest free such that avoiding the use of
                pesticide. <br />
                100% Pesticide free. That's our guarantee
              </motion.p>
            ...
            <div className="flex flex-col items-center p-6 space-y-3 text-center bg-gray-100 rounded-xl ">
              ...
              <motion.p
                ...
                className="text-gray-500"
              >
                Our aeroponic farm is superior in terms of excellent aeration,
                water use efficiency,seasonal independence and disease free
